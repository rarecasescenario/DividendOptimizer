...
public class HttpsClientUtil {
  ...
  public SymbolCurrentState getSymbolData(InputStream yahooDataPage, String symbol)
      throws Exception {
  ...
  /**
   * Scans string and extracts digits in order to build a number representation of the value
   *
